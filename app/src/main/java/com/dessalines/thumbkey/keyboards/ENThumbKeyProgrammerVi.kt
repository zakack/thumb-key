...
val KB_EN_THUMBKEY_PROGRAMMING_VI_MAIN =
    KeyboardC(
        listOf(
            listOf(
                KeyItemC(
...
val KB_EN_THUMBKEY_PROGRAMMING_VI_SHIFTED =
    KeyboardC(
        listOf(
            listOf(
                KeyItemC(
...
val KB_EN_THUMBKEY_PROGRAMMING_VI: KeyboardDefinition =
    KeyboardDefinition(
        title = "english thumb-key programming vi-movement",
        modes =
            KeyboardDefinitionModes(
                main = KB_EN_THUMBKEY_PROGRAMMING_VI_MAIN,
                shifted = KB_EN_THUMBKEY_PROGRAMMING_VI_SHIFTED,
